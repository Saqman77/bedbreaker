...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Gl(){return new vi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:co(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Vl(){return new vi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:co(),fragmentShader:`
...
#define LOW_PRECISION`),t}function B_(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Ac?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===pu?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===bn&&(t="SHADOWMAP_TYPE_VSM"),t}function z_(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case $i:case ji:t="ENVMAP_TYPE_CUBE";break;case Ps:t="ENVMAP_TYPE_CUBE_UV";break}return t}function G_(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case ji:t="ENVMAP_MODE_REFRACTION";break}return t}function V_(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case wc:t="ENVMAP_BLENDING_MULTIPLY";break;case Bu:t="ENVMAP_BLENDING_MIX";break;case zu:t="ENVMAP_BLENDING_ADD";break}return t}function H_(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function k_(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=B_(e),c=z_(e),h=G_(e),u=V_(e),f=H_(e),m=e.isWebGL2?"":P_(e),_=L_(s),g=i.createProgram();let p,d,S=e.glslVersion?"#version "+e.glslVersion+`
